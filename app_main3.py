...
class opcamera(QtCore.QThread):
    signal = pyqtSignal(QImage)
    
    def __init__(self, parent=None):
        super(opcamera,self).__init__(parent)
...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.timelbl()
        self.opencamBtn.clicked.connect(self.vid)
    ...
    def vid(self):
        self.thread = opcamera()
        self.thread.signal.connect(self.opcam)
        self.thread.start()
        
    #@QtCore.pyqtSlot(QImage)
    def opcam(self,image):
        self.lbl_opcam.setPixmap(QtGui.QPixmap.fromImage(image)) 
